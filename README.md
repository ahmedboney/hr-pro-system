...
> يمكن تشغيل مستخدمين متعددين على الشبكة (الربط بين الأجهزة): شغّل على جهاز رئيسي ثم افتح من باقي الأجهزة `http://<IP-الجهاز>:8080`.

## 🔗 ربط الأجهزة على الشبكة

شغّل النظام على جهاز واحد، وليستعمله باقي أجهزة المكتب من المتصفح فقط — شرح كامل مفصل (عنوان IP، جدار الحماية، حسابات، أجهزة البصمة، والإتاحة من خارج المكتب) في ملف **`نوتة_ربط_الاجهزة.md`** المرفق مع النسخة، ومن داخل النظام عبر قسم **«ربط الأجهزة على الشبكة»** في دليل الاستخدام.
